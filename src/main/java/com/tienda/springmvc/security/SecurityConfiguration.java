package com.tienda.springmvc.security;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/logout").access("hasRole('ADMIN') or hasRole('EMPLEADOS') or hasRole('USUARIOS')")
				...
				.antMatchers("/comprarProducto-*").access("hasRole('ADMIN') or hasRole('EMPLEADOS') or hasRole('USUARIOS')")
