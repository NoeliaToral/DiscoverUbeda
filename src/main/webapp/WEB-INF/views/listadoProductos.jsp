  	...
  	<div class="container">
	   <div class="col-md-3 sidebar_box">
		    ...
		    <h3 class="menu_head">Categorías</h3>
			  <ul class="menu">
				<ul class="cute">
					<li class="subitem1"><a href="listarCategorias-Regalos"><img class="arrow-img" src="static/images/f_menu.png" alt=""/>Artesanía</a></li>
...
<div class="footer_bottom">
       	<div class="container">
			...
			<div class="copy">
			    <p>&copy;  2018 Template by <a href="#" target="_blank">Discover Úbeda</a></p>
		    </div>
		    <div class="clearfix"> </div>
       	</div>
</div>
