  	...
  	<div class="container">
	   <div class="col-md-3 sidebar_box">
		    ...
		    <h3 class="menu_head">Products Menu</h3>
			  <ul class="menu">
				<li class="item1"><a href="#"><img class="arrow-img" src="static/images/f_menu.png" alt=""/> Man</a>
					<ul class="cute">
		...
		<script type="text/javascript">
		    ...
		    <div class="delivery">
				<img src="static/images/delivery.jpg" class="img-responsive" alt=""/>
				<h3>Delivering</h3>
				<h4>World Wide</h4>
			</div>
			<div class="twitter">
	   ...
	   <div class="col-md-9 content_right">
	    ...
	    <div class="top_grid2">
	     ...
	     <div class="col-md-4 top_grid1-box1"><a href="single.html">
	     	<div class="grid_1">
	     	  <div class="b-link-stroke b-animate-go  thickbox">
		        <img src="static/images/p4.jpg" class="img-responsive" alt=""/> </div>
	     	  <div class="grid_2">
	     	  	<p>There are many variations of passages</p>
	     	  	<ul class="grid_2-bottom">
	     	  		<li class="grid_2-left"><p>$99<small>.33</small></p></li>
	     ...
	     <div class="col-md-4 top_grid1-box1"><a href="single.html">
	     	<div class="grid_1">
	     	  <div class="b-link-stroke b-animate-go  thickbox">
		        <img src="static/images/p5.jpg" class="img-responsive" alt=""/> </div>
	     	  <div class="grid_2">
	     	  	<p>There are many variations of passages</p>
	     	  	<ul class="grid_2-bottom">
	     	  		<li class="grid_2-left"><p>$99<small>.33</small></p></li>
